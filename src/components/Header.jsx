...
const Header = () => {
  ...
  return (
    <div className='flex border-b-[1px] border-neutral-600 py-[17px] px-[70px] justify-between items-center'>
      ...
      <div className='border-[1px] bg-black/30 backdrop-blur-3xl border-[#0D342C] rounded-[32.27px]'>
      ...
      <div onClick={() => window.open('https://calendly.com/pathpulse-ai', '_blank')}   className='flex bg-black/30 border-l-[#0D342C] border-t-[#0D342C] border-r-[#0D342C] border-l-[1px]  border-r-[1px] border-t-[1px] px-[20.17px] py-[12.1px] rounded-[48.41px] gap-x-[16.4px] backdrop-blur-3xl cursor-pointer'>
